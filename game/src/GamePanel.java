...
public class GamePanel extends JPanel implements ActionListener {
   ...
   * This means we'll create only one instance of that static member that is
   * shared across all instances of the class.
   */
  static final int SCREEN_WIDTH = 600;
  static final int SCREEN_HEIGHT = 600;

  static final int UNIT_SIZE = 25; // size of each unit in the gamepanel
  static final int GAME_UNITS = (SCREEN_WIDTH * SCREEN_HEIGHT) / UNIT_SIZE;

  // to maintain the speed of the game
  static final int DELAY = 75;

  // to hold the x & y coordinates of the snake body parts; the size cannot exceed
  // the Gameunits size
   ...
   * For example, the window in which the applet is running may be overwritten by
   * another window and then uncovered
   */
  /*
   * The Graphics class provides basic drawing methods such as drawLine, drawRect,
   * and drawString
   */
  ...
  // We have to implement the methods defined in the Listener interface
  @Override
...
/*
 * ) Note:
 * The repaint method in java is available in java.applet.Applet class is a
 * final method used whenever we want to call update method along with the call
 * to paint method;
 * call to update method clears the current window, performs an update, and
 * afterwards calls paint method.
 */